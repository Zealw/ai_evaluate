package com.evaluate.ai_evaluate.utils;
...
public class BigModelNew extends WebSocketListener {
    ...
    public static final String appid = "d19dd882";
    public static final String apiSecret = "YzNiM2E0ZmU2ZDY0ZmJhMmViY2NiODcx";
    public static final String apiKey = "30d8fa87ce50f5767d0f126bcdad8b97";

    public static List<RoleContent> historyList=new ArrayList<>(); // 对话历史存储集合

    public static String totalAnswer=""; // 大模型的答案汇总
    public static String finalAnswer=""; // 大模型的答案汇总
    public static List<MultipartFile> multipartFiles; // 大模型的答案汇总
    ...
    public String[] getEvaluation(List<MultipartFile> pics,String text) throws Exception {
        // 个性化参数入口，如果是并发使用，可以在这里模拟
           if(totalFlag){
            ...
            try {
                ...
                if(!ImageAddFlag){
                    ...
                    for (MultipartFile file : multipartFiles) {
                        roleContent.content=Base64.getEncoder().encodeToString(file.getBytes());
